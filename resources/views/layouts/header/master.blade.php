<header class="doc-header">
        ...
        <div class="row p-4">
            <div class="col-md-6">
                <a href="" class="inline-block logo-link">
                    <img src="{{ url('storage/Logo.png') }}" alt="" style="max-width: 100%;" class="logo-image">
                </a>
            </div>
            <div class="col-md-3">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white shadow-sm" style="background-color:#85929e">
